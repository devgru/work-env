    ...
    return (
      ...
      >
        ...
        <Slide>
          ...
          <SPAN />
          <Notes>
            <p>Большое впечатление на меня произвела история Никиты Прокопова, о том как он 5 лет провёл в депрессии. Отдельно я удивился реакции в твиттере: народ принялся обсуждать, а на самом ли деле это депрессия или нет и т.п.</p>
        ...
        <Slide>
          ...
          <SPAN />
          <Notes>
            <p>История Ани из «Злых Марсиан» похожа. Она работала в Злых Марсианах, и это интересный пример того чем может обернуться «работа мечты»</p>
        ...
        <Slide>
          ...
          <SPAN />
          <Notes>
            <p>Известный в узких кругах блогер — Сергей Король — описал свой опыт психотерапии.</p>
            <p>И тоже вызвал порядочно комментариев на тему.</p>
        ...
        <Slide bgImage={aaa} bgSize="contain" bgRepeat="no-repeat"></Slide>
        <Slide>
          <LText textColor="secondary">
            Ликбез →
          </LText>
